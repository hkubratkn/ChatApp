...
import com.kapirti.video_food_delivery_shopping.common.ext.getYearFromTimeStamp


@Composable
fun PhotosContent(
    hobbys: List<com.kapirti.video_food_delivery_shopping.model.UserPhotos>,
...
@Composable
private fun Photos(
    photos: List<com.kapirti.video_food_delivery_shopping.model.UserPhotos>,
    modifier: Modifier = Modifier
) {
    LazyRow(
        modifier = modifier,
...
private fun PhotoItem(
    userPhoto: com.kapirti.video_food_delivery_shopping.model.UserPhotos,
    modifier: Modifier = Modifier
) {
