...
object SearchRepo {
    ...
    suspend fun search(query: String, users: List<com.kapirti.pomodorotechnique_timemanagementmethod.model.User>): List<com.kapirti.pomodorotechnique_timemanagementmethod.model.User> = withContext(Dispatchers.Default) {
        delay(200L)
