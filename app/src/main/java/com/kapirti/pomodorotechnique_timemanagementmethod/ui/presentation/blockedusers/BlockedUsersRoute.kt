...
import com.kapirti.pomodorotechnique_timemanagementmethod.core.constants.ConsAds.ADS_BLOCKED_USERS_BANNER_ID
...
fun BlockedUsersRoute(
    ...
    Scaffold(
        ...
        topBar = {
            MenuToolbar(
                text = stringResource(id = AppText.blocked_users_title),
        ...
        if (blockedUsers.isEmpty()) {
            EmptyContent(
                ...
                label = AppText.no_blocked_users_all,
