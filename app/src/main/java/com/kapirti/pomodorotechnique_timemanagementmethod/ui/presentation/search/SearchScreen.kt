...
private fun rememberSearchState(
    ...
    searchResults: List<com.kapirti.pomodorotechnique_timemanagementmethod.model.User> = emptyList()
): SearchState {
    return remember {
        SearchState(
            query = query,
...
class SearchState(
    ...
    searchResults: List<com.kapirti.pomodorotechnique_timemanagementmethod.model.User>
) {
