...
package com.kapirti.pomodorotechnique_timemanagementmethod.past.core.usecase
/**
...
class PublishThemeUpdateUseCase @Inject constructor(
    ...
    suspend operator fun invoke(theme: com.kapirti.pomodorotechnique_timemanagementmethod.past.model.Theme) = repository.publishThemeUpdate(theme)
}
*/
