...
class EditViewModel @Inject constructor(
    ...
    private val storageService: com.kapirti.pomodorotechnique_timemanagementmethod.past.model.service.StorageService,
    ...
    fun onDeleteMyAccountClick(
        ...
        launchCatching {
            ...
            firestoreService.deleteAccount(
                com.kapirti.pomodorotechnique_timemanagementmethod.past.model.Delete(
    ...
    private fun feedbackSave(popUp: () -> Unit) {
        launchCatching {
            firestoreService.saveFeedback(
                feedback = com.kapirti.pomodorotechnique_timemanagementmethod.past.model.Feedback(
                    text = _description.value ?: "",
