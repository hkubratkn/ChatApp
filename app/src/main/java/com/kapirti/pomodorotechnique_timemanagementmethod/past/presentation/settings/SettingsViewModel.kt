...
package com.kapirti.pomodorotechnique_timemanagementmethod.past.presentation.settings
/**
...
class SettingsViewModel @Inject constructor(
    ...
    private val _theme by lazy { mutableStateOf(com.kapirti.pomodorotechnique_timemanagementmethod.past.model.Theme.Light) }
    val theme: State<com.kapirti.pomodorotechnique_timemanagementmethod.past.model.Theme> by lazy { _theme.apply { updateTheme() } }
    ...
    private fun updateTheme() {
        launchCatching {
            _theme.value = com.kapirti.pomodorotechnique_timemanagementmethod.past.model.Theme.valueOf(getThemePreferencesUseCase())
        }
    }


    fun onThemeChanged(theme: com.kapirti.pomodorotechnique_timemanagementmethod.past.model.Theme) {
        launchCatching {
