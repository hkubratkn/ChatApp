...
package com.kapirti.pomodorotechnique_timemanagementmethod.past.core.repository
/**
...
internal class UserPreferencesRepositoryImpl @Inject constructor(
    ...
    override suspend fun getThemeUpdate(): SharedFlow<com.kapirti.pomodorotechnique_timemanagementmethod.past.model.Theme> = localDataSource.getThemeUpdate()

    override suspend fun publishThemeUpdate(theme: com.kapirti.pomodorotechnique_timemanagementmethod.past.model.Theme) =
