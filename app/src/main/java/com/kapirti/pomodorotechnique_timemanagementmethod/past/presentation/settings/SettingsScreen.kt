...
fun SettingsScreen(
    ...
    Column(
        ...
        ThemeCardEditor(
            ...
            content = "",
            checked = theme == com.kapirti.pomodorotechnique_timemanagementmethod.past.model.Theme.Dark,
            onCheckedChange = {
                viewModel.onThemeChanged(if (it) com.kapirti.pomodorotechnique_timemanagementmethod.past.model.Theme.Dark else com.kapirti.pomodorotechnique_timemanagementmethod.past.model.Theme.Light)
            },
