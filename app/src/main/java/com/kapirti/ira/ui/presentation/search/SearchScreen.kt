...
import com.kapirti.ira.core.constants.ConsAds.ADS_SEARCH_BANNER_ID
...
private fun rememberSearchState(
    ...
    searchResults: List<com.kapirti.ira.model.User> = emptyList()
): SearchState {
    return remember {
        SearchState(
            query = query,
...
class SearchState(
    ...
    searchResults: List<com.kapirti.ira.model.User>
) {
