...
import com.kapirti.video_food_delivery_shopping.common.ext.tabContainerModifier
import com.kapirti.video_food_delivery_shopping.ui.presentation.profile.ext.InterestsAdaptiveContentLayout
...
private fun PhotosContent(
    loading: Boolean,
    items: List<com.kapirti.video_food_delivery_shopping.model.UserPhotos>,
    onRefresh: () -> Unit,
    onAssetClick: () -> Unit,
    modifier: Modifier = Modifier,
) {
