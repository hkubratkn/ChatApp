...
import com.kapirti.ira.core.datastore.LocalDataSource
...
internal class UserPreferencesRepositoryImpl @Inject constructor(
    ...
    override suspend fun getThemeUpdate(): SharedFlow<com.kapirti.ira.model.Theme> = localDataSource.getThemeUpdate()

    override suspend fun publishThemeUpdate(theme: com.kapirti.ira.model.Theme) =
