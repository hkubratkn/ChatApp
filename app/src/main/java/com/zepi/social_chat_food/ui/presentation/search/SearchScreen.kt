...
import com.zepi.social_chat_food.core.constants.ConsAds.ADS_SEARCH_BANNER_ID
...
private fun rememberSearchState(
    ...
    searchResults: List<com.zepi.social_chat_food.model.User> = emptyList()
): SearchState {
    return remember {
        SearchState(
            query = query,
...
class SearchState(
    ...
    searchResults: List<com.zepi.social_chat_food.model.User>
) {
