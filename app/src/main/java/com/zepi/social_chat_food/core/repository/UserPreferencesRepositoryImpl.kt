...
import com.zepi.social_chat_food.core.datastore.LocalDataSource
...
internal class UserPreferencesRepositoryImpl @Inject constructor(
    ...
    override suspend fun getThemeUpdate(): SharedFlow<com.zepi.social_chat_food.model.Theme> = localDataSource.getThemeUpdate()

    override suspend fun publishThemeUpdate(theme: com.zepi.social_chat_food.model.Theme) =
