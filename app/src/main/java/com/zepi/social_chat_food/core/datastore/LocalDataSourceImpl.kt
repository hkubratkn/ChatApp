...
internal class LocalDataSourceImpl @Inject constructor(
    ...
    private val themeUpdateFlow = MutableSharedFlow<com.zepi.social_chat_food.model.Theme>()

    override suspend fun getThemeUpdate(): SharedFlow<com.zepi.social_chat_food.model.Theme> = themeUpdateFlow

    override suspend fun publishThemeUpdate(theme: com.zepi.social_chat_food.model.Theme) = themeUpdateFlow.emit(theme)
